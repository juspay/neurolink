...
const screenshotsDir = path.join(__dirname, '../docs/visual-content/screenshots/phase-1-2-workflow');
...
async function captureScreenshots() {
  ...
  try {
    ...
    // Wait for completion
    await page.waitForSelector('text=Test cases generated successfully', { timeout: 30000 });
    ...
    // Wait for completion
    await page.waitForSelector('text=Code refactored successfully', { timeout: 30000 });
    await page.waitForTimeout(500);
    await page.screenshot({
    ...
    await page.waitForTimeout(100);
    await page.screenshot({
      path: path.join(screenshotsDir, '06-generate-documentation-in-progress.png'),
      fullPage: false
    });

    // Wait for completion
    await page.waitForSelector('text=Documentation generated successfully', { timeout: 30000 });
    await page.waitForTimeout(500);
    await page.screenshot({
