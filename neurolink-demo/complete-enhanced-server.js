...
The quality is good but delivery was slow.</textarea>
      ...
      <script>
        ...
        let currentStats = { requests: 0, providers: 0, tokens: 0 };
        ...
        function updateMetrics(response) {
          if (response.usage) {
            ...
            document.getElementById('total-tokens').textContent = currentStats.tokens;
          }
          currentStats.requests++;
          document.getElementById('total-requests').textContent = currentStats.requests;
        }
