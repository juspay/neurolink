...
import {
  ProcessorPipeline,
  IOProcessorRegistry as ProcessorRegistry,
...
describe("Processor Integration", () => {
  describe("ProcessorRegistry", () => {
    ...
    it("should register and retrieve input processors", () => {
      ...
      expect(registered?.id).toBe("message-validation");
    });
    ...
    it("should register and retrieve output processors", () => {
      ...
      expect(registered).toBeDefined();
      expect(registered?.id).toBe("length-validation");
    });
  ...
  describe("ProcessorPipeline", () => {
    ...
    it("should abort on empty content when required", async () => {
      ...
      expect(result.feedback.some((f) => f.includes("empty"))).toBe(true);
    });
    ...
    it("should accumulate issues from processors", async () => {
      ...
      expect(
        result.metadata.issues.some((i) => i.category === "length_validation"),
      ).toBe(true);
    });
