...
import type { Migration } from "../../src/lib/storage/types/storageTypes.js";
...
describe("MigrationManager", () => {
  ...
  describe("Forward Migration", () => {
    ...
    it("should apply migrations in order", async () => {
      ...
      manager.registerAll([
        ...
        { version: 3, name: "third", up: async () => { order.push(3); } },
      ]);
  ...
  describe("Rollback", () => {
    ...
    it("should rollback in reverse order", async () => {
      ...
      manager.registerAll([
        { version: 1, name: "first", up: vi.fn(), down: async () => { order.push(1); } },
        { version: 2, name: "second", up: vi.fn(), down: async () => { order.push(2); } },
        { version: 3, name: "third", up: vi.fn(), down: async () => { order.push(3); } },
      ]);
