...
import type {
  ThreadRecord,
  MessageRecord,
} from "../../../src/lib/storage/types/storageTypes.js";
...
describe("MemoryStorageAdapter", () => {
  ...
  describe("Thread Operations", () => {
    ...
    it("should list threads with sorting", async () => {
      await storage.createThread({ id: "thread-1", resourceId: "user-1", title: "C" });
      await storage.createThread({ id: "thread-2", resourceId: "user-1", title: "A" });
      await storage.createThread({ id: "thread-3", resourceId: "user-1", title: "B" });
  ...
  describe("Message Operations", () => {
    ...
    it("should get messages by thread", async () => {
      await storage.createMessage({ id: "msg-1", threadId: "thread-1", role: "user", content: "1" });
      await storage.createMessage({ id: "msg-2", threadId: "thread-1", role: "assistant", content: "2" });
    ...
    it("should list messages with filtering", async () => {
      await storage.createMessage({ id: "msg-1", threadId: "thread-1", role: "user", content: "1" });
      await storage.createMessage({ id: "msg-2", threadId: "thread-1", role: "assistant", content: "2" });
      await storage.createMessage({ id: "msg-3", threadId: "thread-1", role: "user", content: "3" });
  ...
  describe("Workflow Run Operations", () => {
    ...
    it("should list workflow runs by workflow ID", async () => {
      await storage.createWorkflowRun({ id: "run-1", workflowId: "workflow-1", status: "completed" });
      await storage.createWorkflowRun({ id: "run-2", workflowId: "workflow-1", status: "pending" });
      await storage.createWorkflowRun({ id: "run-3", workflowId: "workflow-2", status: "completed" });
  ...
  describe("Query Operators", () => {
    beforeEach(async () => {
      await storage.createThread({ id: "t1", resourceId: "user-1", title: "Alpha" });
      await storage.createThread({ id: "t2", resourceId: "user-2", title: "Beta" });
      await storage.createThread({ id: "t3", resourceId: "user-1", title: "Gamma" });
    });
