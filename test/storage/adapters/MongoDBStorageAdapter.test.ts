...
describe("MongoDBStorageAdapter", () => {
  ...
  let mockClient: { connect: ReturnType<typeof vi.fn>; db: ReturnType<typeof vi.fn> };
  let mockDb: { collection: ReturnType<typeof vi.fn>; command: ReturnType<typeof vi.fn> };
