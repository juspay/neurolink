...
describe("FileStorageAdapter", () => {
  ...
  describe("Thread Operations", () => {
    ...
    it("should update a thread", async () => {
      await storage.createThread({ id: "t1", resourceId: "user-1", title: "Original" });
  ...
  describe("Message Operations", () => {
    ...
    it("should get messages by thread", async () => {
      await storage.createMessage({ id: "m1", threadId: "thread-1", role: "user", content: "1" });
      await storage.createMessage({ id: "m2", threadId: "thread-1", role: "assistant", content: "2" });
  ...
  describe("Data Persistence", () => {
    it("should persist data across restarts", async () => {
      await storage.createThread({ id: "t1", resourceId: "user-1" });
      await storage.createMessage({ id: "m1", threadId: "t1", role: "user", content: "Hello" });
  ...
  describe("Error Handling", () => {
    it("should throw error for invalid path", async () => {
      const invalidStorage = new FileStorageAdapter({ path: "/nonexistent/dir/file.json" });
