...
[NeuroLink API Reference](../README.md) / ServeState

# Type Alias: ServeState
...
Defined in: [types/cli.ts:1600](https://github.com/juspay/neurolink/blob/release/src/lib/types/cli.ts#L1600)
