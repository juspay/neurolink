...
Defined in: [types/providers.ts:2662](https://github.com/juspay/neurolink/blob/release/src/lib/types/providers.ts#L2662)
...
Defined in: [types/providers.ts:2664](https://github.com/juspay/neurolink/blob/release/src/lib/types/providers.ts#L2664)
