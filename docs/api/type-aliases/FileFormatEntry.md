...
Defined in: [types/file.ts:113](https://github.com/juspay/neurolink/blob/release/src/lib/types/file.ts#L113)
...
Defined in: [types/file.ts:115](https://github.com/juspay/neurolink/blob/release/src/lib/types/file.ts#L115)
