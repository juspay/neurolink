...
[NeuroLink API Reference](../README.md) / ContextConfig

# Type Alias: ContextConfig

> **ContextConfig** = `object`

Defined in: [types/context.ts:54](https://github.com/juspay/neurolink/blob/release/src/lib/types/context.ts#L54)
