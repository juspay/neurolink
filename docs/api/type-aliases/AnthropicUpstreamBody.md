...
[NeuroLink API Reference](../README.md) / AnthropicUpstreamBody

# Type Alias: AnthropicUpstreamBody
...
> **preparedContext**: [`ProxyPreparedContext`](ProxyPreparedContext.md)\<[`ClaudeRequest`](ClaudeRequest.md)\>
