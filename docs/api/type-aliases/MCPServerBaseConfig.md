...
Defined in: [types/mcp.ts:1080](https://github.com/juspay/neurolink/blob/release/src/lib/types/mcp.ts#L1080)
...
Defined in: [types/mcp.ts:1082](https://github.com/juspay/neurolink/blob/release/src/lib/types/mcp.ts#L1082)
