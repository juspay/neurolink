...
[NeuroLink API Reference](../README.md) / AffinityRule

# Type Alias: AffinityRule
...
Defined in: [types/mcp.ts:2444](https://github.com/juspay/neurolink/blob/release/src/lib/types/mcp.ts#L2444)
