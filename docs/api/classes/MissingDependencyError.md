...
Defined in: [server/errors.ts:530](https://github.com/juspay/neurolink/blob/release/src/lib/server/errors.ts#L530)
...
Defined in: [server/errors.ts:531](https://github.com/juspay/neurolink/blob/release/src/lib/server/errors.ts#L531)
