...
Defined in: [server/errors.ts:318](https://github.com/juspay/neurolink/blob/release/src/lib/server/errors.ts#L318)
...
Defined in: [server/errors.ts:319](https://github.com/juspay/neurolink/blob/release/src/lib/server/errors.ts#L319)
