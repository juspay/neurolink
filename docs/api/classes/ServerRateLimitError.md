...
Defined in: [server/errors.ts:254](https://github.com/juspay/neurolink/blob/release/src/lib/server/errors.ts#L254)
...
Defined in: [server/errors.ts:255](https://github.com/juspay/neurolink/blob/release/src/lib/server/errors.ts#L255)
