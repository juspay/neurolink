...
Defined in: [utils/avatarProcessor.ts:46](https://github.com/juspay/neurolink/blob/release/src/lib/utils/avatarProcessor.ts#L46)
...
Defined in: [utils/avatarProcessor.ts:47](https://github.com/juspay/neurolink/blob/release/src/lib/utils/avatarProcessor.ts#L47)
