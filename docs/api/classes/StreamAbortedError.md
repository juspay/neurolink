...
Defined in: [server/errors.ts:334](https://github.com/juspay/neurolink/blob/release/src/lib/server/errors.ts#L334)
...
Defined in: [server/errors.ts:335](https://github.com/juspay/neurolink/blob/release/src/lib/server/errors.ts#L335)
