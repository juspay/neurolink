...
Defined in: [server/errors.ts:216](https://github.com/juspay/neurolink/blob/release/src/lib/server/errors.ts#L216)
...
Defined in: [server/errors.ts:217](https://github.com/juspay/neurolink/blob/release/src/lib/server/errors.ts#L217)
