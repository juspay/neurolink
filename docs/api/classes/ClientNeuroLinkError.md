...
Defined in: [client/errors.ts:74](https://github.com/juspay/neurolink/blob/release/src/lib/client/errors.ts#L74)
...
Defined in: [client/errors.ts:86](https://github.com/juspay/neurolink/blob/release/src/lib/client/errors.ts#L86)
