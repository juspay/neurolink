...
[NeuroLink API Reference](../globals.md) / createAIProvider

# Function: createAIProvider()

> **createAIProvider**(`providerName?`, `modelName?`): `Promise`\<[`AIProvider`](../type-aliases/AIProvider.md)\>

Defined in: [index.ts:158](https://github.com/juspay/neurolink/blob/997832c0dc437abf3a045a6ab43aafda5c330f4e/src/lib/index.ts#L158)
