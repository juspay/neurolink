...
Defined in: [services/server/ai/observability/instrumentation.ts:1515](https://github.com/juspay/neurolink/blob/release/src/lib/services/server/ai/observability/instrumentation.ts#L1515)
