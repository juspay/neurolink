...
| Feature                                                                             | Description                                                                                        |
| ----------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- |
| :material-microphone: **[Audio Streaming Support](audio-support.md)**               | Real-time bidirectional audio streaming with Gemini Live API for voice conversations.              |
...
| **Multimodal pipeline**  | Stream images + CSV data + PDF documents + audio across providers with local/remote assets. Auto-detection for mixed file types. | [Multimodal Guide](multimodal-chat.md), [CSV Support](csv-support.md), [PDF Support](pdf-support.md), [Audio Support](audio-support.md) |
