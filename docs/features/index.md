...
| Feature                                                                                  | Description                                                                                                                                                                                                                                                                                |
| ---------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **[`decide` Inference Type](/docs/features/decide-inference-type)**                      | A third inference type alongside `generate`/`stream`: typed, calibrated `boolean`/`choice`/`score` judgments in one parallel pass — no text. ~400ms, ~$0.00002 per decision. First provider is [TypeSafe Jev](/docs/getting-started/providers/typesafe). Fail-open: a no-op without a key. |
