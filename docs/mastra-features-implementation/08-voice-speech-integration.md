...
### Target State (Mastra-Style)

Extend the current architecture to support:

- **Multiple TTS providers**: ElevenLabs, OpenAI TTS, Azure Speech, Sarvam, Murf, Play.ai, Speechify
- **Multiple STT providers**: Deepgram, Gladia, OpenAI Whisper
- **Realtime Voice**: OpenAI Realtime API, Google Gemini Live API
