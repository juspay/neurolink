...
Respond with ONLY the JSON object, no explanation.`;
  ...
  try {
    ...
    const enumsModule = await import("../../constants/enums.js");
    type AIProviderNameType =
      (typeof enumsModule.AIProviderName)[keyof typeof enumsModule.AIProviderName];
    ...
    console.warn(
      "[ContentModeration] AI moderation failed, falling back to heuristics:",
