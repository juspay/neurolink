...
/**
 * Safe attribute keys allowed in metadata sent to external services.
 * Intentionally excludes input, output, error.stack, and other user content
 * to prevent PII leakage to third-party services.
 */
