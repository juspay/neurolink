...
Current user's request: ${currentInput}`;
   ...
   * @param optionsOrPrompt.structuredOutput - JSON schema for structured output
   ...
   * @param optionsOrPrompt.thinkingLevel - Extended thinking level ('minimal', 'low', 'medium', 'high')
