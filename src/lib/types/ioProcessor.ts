...
export type ProcessorPipelineConfig = {
  /** Pipeline name */
  name?: string;
  /** Stop on first abort (top-level shorthand for settings.stopOnAbort) */
  stopOnAbort?: boolean;
  /** Timeout for entire pipeline in ms (top-level shorthand for settings.pipelineTimeout) */
 ...
 */
export type ProcessorPipelineResult<T> = {
  ...
  totalTime: number;
  /** Number of processors that were executed */
 ...
 */
export type ProcessorValidationResult = {
  valid: boolean;
  errors: string[];
  warnings: string[];
};
...
export type MessageValidationConfig = {
  ...
  /** Abort if text is empty or whitespace-only */
  requireContent?: boolean;
  /** Custom validation function */
  customValidator?: (data: InputProcessorData) => ProcessorValidationResult;
};
 ...
 */
export type ProcessorResultBase = {
  /** The action to take */
 ...
 */
export type ProcessorContinueResult<TData> = ProcessorResultBase & {
  action: "continue";
  /** The processed data */
  data: TData;
};
 ...
 * Retry action result
 */
export type ProcessorRetryResult<TData> = ProcessorResultBase & {
  action: "retry";
 ...
 */
export type RegisteredProcessor<
  TProcessor,
  _TConfig extends BaseProcessorConfig = BaseProcessorConfig,
> = {
 ...
 */
export type PipelineExecutionResult<TData> = {
 ...
 */
export type ProcessorRegistryStats = {
 ...
 */
export type ProcessorListResult = {
...
// ============================================================================
// Error Types (from errors/IOProcessorError.ts)
// ============================================================================
 ...
 */
export type IOProcessorErrorContext = {
...
// ============================================================================
// Factory Options Types (from utils/processorFactory.ts)
// ============================================================================

/**
 * Options for creating an input processor
 */
export type CreateInputProcessorOptions<TConfig = JsonObject> = {
  /** Unique processor ID */
  id: string;
  /** Human-readable name */
  name: string;
  ...
  /** Optional config validation function */
  validateConfig?: (config: TConfig) => { valid: boolean; errors: string[] };
};

/**
 * Options for creating an output processor
 */
export type CreateOutputProcessorOptions<TConfig = JsonObject> = {
  /** Unique processor ID */
  id: string;
  /** Human-readable name */
  name: string;
...
// ============================================================================
// Validation Result Types (from utils/validationUtils.ts)
// ============================================================================

/**
 * Validation result type for processor config validation
 */
export type ProcessorConfigValidationResult = {
  valid: boolean;
  errors: string[];
};
