...
/**
 * Get all outputs as typed object
 */
export function getActionOutputs(
  ...
  return {
    ...
    model: result.model,
    tokensUsed: result.usage?.totalTokens?.toString(),
    promptTokens: result.usage?.promptTokens?.toString(),
    completionTokens: result.usage?.completionTokens?.toString(),
    cost: result.cost?.toString(),
    executionTime: result.executionTime?.toString(),
    evaluationScore: result.evaluation?.overallScore?.toString(),
    commentId: commentResult?.commentId?.toString(),
  };
}
