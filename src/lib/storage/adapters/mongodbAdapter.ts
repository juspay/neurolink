...
/**
 * MongoDB document interface for threads
 */
...
/**
 * MongoDB document interface for messages
 */
...
/**
 * MongoDB document interface for workflow runs
 */
...
/**
 * MongoDB document interface for custom records
 */
interface CustomRecordDocument {
...
export class MongoDBAdapter extends BaseStorageProvider {
  ...
  private mapWorkflowRunDocument(doc: WorkflowRunDocument): StorageWorkflowRun {
    return {
      ...
      output: doc.output,
      error: doc.error as WorkflowError | undefined,
