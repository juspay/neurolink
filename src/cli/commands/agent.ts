...
import type {
  ...
  NetworkErrorChunk,
} from "../../lib/types/agentNetworkTypes.js";
...
export type { AgentCommandArgs, NetworkCommandArgs };
...
export class AgentCommandFactory {
      ...
      builder: (yargs) => {
        return yargs
          .command(
            ...
            (argv) => this.executeCreate(argv as AgentCommandArgs),
          )
          .command(
            "list",
            "List registered agents",
            (yargs) => this.buildListOptions(yargs),
            (argv) => this.executeList(argv as AgentCommandArgs),
          )
          .command(
            "execute <id> <input>",
            "Execute a single agent with given input",
            (yargs) => this.buildExecuteOptions(yargs),
            (argv) => this.executeAgent(argv as AgentCommandArgs),
          )
          .command(
            "run <id> <input>",
      ...
      builder: (yargs) => {
        return yargs
          .command(
            ...
            (argv) => this.executeNetworkCreate(argv as NetworkCommandArgs),
          )
          .command(
            "list",
            "List registered networks",
            (yargs) => this.buildNetworkListOptions(yargs),
            (argv) => this.executeNetworkList(argv as NetworkCommandArgs),
          )
          .command(
            "execute <id> <input>",
            "Execute an agent network with given input",
            (yargs) => this.buildNetworkExecuteOptions(yargs),
            (argv) => this.executeNetwork(argv as NetworkCommandArgs),
          )
          .command(
            "run <id> <input>",
  ...
  private static async executeCreate(argv: AgentCommandArgs): Promise<void> {
  ...
  private static async executeList(argv: AgentCommandArgs): Promise<void> {
    try {
  ...
  private static async executeAgent(argv: AgentCommandArgs): Promise<void> {
  ...
  private static async executeNetwork(argv: NetworkCommandArgs): Promise<void> {
