...
process.env.AWS_SECRET_ACCESS_KEY = process.env.AWS_SECRET_ACCESS_KEY || 'test-secret-aws';
process.env.AWS_REGION = process.env.AWS_REGION || 'us-east-1';
process.env.BEDROCK_MODEL = process.env.BEDROCK_MODEL || 'anthropic.claude-3-sonnet-20240229-v1:0';
